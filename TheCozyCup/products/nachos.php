<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //$redirectUrl = "/products/nachos.php";
        
        // Dynamic base URL
        $baseUrl = "https://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['SCRIPT_NAME']);
        $redirectUrl = $baseUrl . "/nachos.php";
...
<html lang="en">
<head>
    <title>Product: Nachos</title>
</head>
<body>
    <h1>Nachos</h1>
    <img src="../images/food/nachos.png" alt="Nachos">
    <p>Crispy, golden corn tortilla chips piled high and generously layered with melted cheese, savory toppings, and a dash of spice, our Nachos bring a burst of flavor in every bite. Perfectly complemented by creamy guacamole, zesty salsa, and a dollop of sour cream, this classic favorite offers a deliciously satisfying crunch. Ideal for sharing or savoring solo, these Nachos are a delightful mix of textures and tastes, making them the ultimate comfort snack to enjoy anytime.</p>
    <p>Price: $2.50</p>
    ...
    $sql = "SELECT username, comment, is_liked 
            ...
            WHERE product_name = 'Nachos' AND comment IS NOT NULL
            ORDER BY id DESC 
            LIMIT 5";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
