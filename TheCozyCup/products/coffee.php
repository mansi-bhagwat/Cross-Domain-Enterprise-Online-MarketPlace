<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        //$redirectUrl = "/products/coffee.php";
        // Dynamic base URL
        $baseUrl = "https://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['SCRIPT_NAME']);
        $redirectUrl = $baseUrl . "/coffee.php";
...
<body>
    <h1>Coffee</h1>
    <img src="../images/food/coffee.jpeg" alt="Coffee">
    <p>Freshly brewed coffee with a rich aroma.</p>
    <p>Price: $3.00</p>
    ...
    $sql = "SELECT username, comment, is_liked 
            ...
            WHERE product_name = 'Coffee' AND comment IS NOT NULL
            ORDER BY id DESC 
            LIMIT 5";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
